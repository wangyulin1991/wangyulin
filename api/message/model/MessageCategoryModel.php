...
class MessageCategoryModel extends CommonModel
{
    //类型转换
    protected $type = [
        'more' => 'array',
    ...
    {
        $query->alias('message_category')->where('delete_time', 0)
            ->where('message_category.status', 1);
    }
    ...
    {
        return $this->belongsToMany('MessagePostModel', 'message_category_post', 'post_id', 'category_id');
    }
    ...
    {
        return self::hasMany('MessageCategoryPostModel', 'category_id', 'id');
    }
